        ...
        try {
            ...
            try {
                ...
                if (universityResponse.ok) {
                    ...
                    const csvUniversityWords = this.parseUniversityCSV(universityText);
                    if (Object.keys(csvUniversityWords).length > 0) {
                        this.universityWords = csvUniversityWords;
                        console.log('Loaded university word data from CSV');
                    }
                }
            } catch (error) {
                console.log('Using embedded university data (CSV not available)');
            }
